///////////
// DPSF Library Classes by Daniel Schroeder, latest update 31/08/13
// Available at: http://www.xnaparticles.com/
///////////
...
namespace GeckoFactionRRR
{
    ...
    class TrailParticleSystem : DefaultTexturedQuadParticleSystem
    {
        ...
        {
            InitializeTexturedQuadParticleSystem(cGraphicsDevice, cContentManager, 1000, 1000,
        ...
        public void LoadParticleSystem()
        {
            ...
            Emitter.OrientationData.RotationalVelocity = Vector3.Zero;/*new Vector3(0, 0, (float)Math.PI)*/;
            Emitter.ParticlesPerSecond = 50;//100;

            TrailStartColor = Color.Red;
            TrailEndColor = Color.Yellow;
            TrailStartSize = 20;//5;
            TrailEndSize = 1;// 40;
            SetTexture( "Textures/Particle" /*"Textures/WhiteSquare"*/);
        ...
        ////test
        public void InitializeParticleTrailShort(DefaultTexturedQuadParticle cParticle)
        {
        ...
        public void LoadParticleSystemShort()
        {
            ParticleInitializationFunction = InitializeParticleTrailShort;
            ...
            Emitter.PositionData.Position = _emittersLastPosition = new Vector3(0, 50, 0);
            Emitter.OrientationData.RotationalVelocity = Vector3.Zero;/*new Vector3(0, 0, (float)Math.PI)*/;
            Emitter.ParticlesPerSecond = 10;//50;//100;
